...
A highly configurable skill progression mod.

## Description

This mod gives you options for scaling skill growth by various parameters. By default it does nothing, you will need to configure it yourself based on your needs.
